...
/**
 * Map of sidebar item href → SVG icon.
 * Each icon is a unique stroke-based SVG.
 */
export const SIDEBAR_ICONS: Record<string, React.ReactNode> = {
  ...
  "settings/groups": (
    <svg {...props}><circle cx="18" cy="5" r="3"/><circle cx="6" cy="5" r="3"/><circle cx="18" cy="19" r="3"/><circle cx="6" cy="19" r="3"/><path d="M6 8v8"/><path d="M18 8v8"/></svg>
  ),
