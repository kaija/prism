...
-- CreateIndex
CREATE UNIQUE INDEX "UserGroup_projectId_name_key" ON "UserGroup"("projectId", "name");

-- CreateIndex
CREATE UNIQUE INDEX "UserGroupMember_userGroupId_userId_key" ON "UserGroupMember"("userGroupId", "userId");
...
-- AddForeignKey
ALTER TABLE "UserGroup" ADD CONSTRAINT "UserGroup_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
